...
"[project]/.next-internal/server/app/api/store/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/src/app/api/store/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
async function GET() {
    const items = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listStoreItems"])();
...
async function POST(request) {
    ...
    if (!title || !cost) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'missing'
    }, {
        status: 400
    });
    const item = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createStoreItem"])(String(title), Number(cost), description ? String(description) : undefined);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        item
    });
}
async function DELETE(request) {
    ...
    const ok = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteStoreItem"])(id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__baddb242._.js.map