...
;
async function GET() {
    const tasks = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listTasks"])();
...
async function POST(req) {
    ...
    if (!body?.title || typeof body.points !== 'number') {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'title and points required'
        }, {
            status: 400
        });
    }
    const task = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createTask"])(body.title, body.points, body.description, body.tag);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        task
    });
}
async function PATCH(req) {
    ...
    const task = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateTask"])(body.id, {
        title: body.title,
        points: body.points,
...
async function DELETE(req) {
    ...
    if (!id || isNaN(Number(id))) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'id required'
    }, {
        status: 400
    });
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteTask"])(Number(id));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__06adb13d._.js.map