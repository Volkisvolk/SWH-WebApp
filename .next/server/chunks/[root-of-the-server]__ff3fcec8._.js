...
"[project]/.next-internal/server/app/api/assign/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/src/app/api/assign/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    if (!body?.userId || !body?.taskId) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'userId and taskId required'
    }, {
        status: 400
    });
    const a = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assignTask"])(Number(body.taskId), Number(body.userId));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ff3fcec8._.js.map