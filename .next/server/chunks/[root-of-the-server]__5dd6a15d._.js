...
"[project]/.next-internal/server/app/api/user/assignments/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/src/app/api/user/assignments/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    const session = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifySession"])(token);
    ...
    const [assignments, tasks, users] = await Promise.all([
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listAssignmentsForUser"])(session.id),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listTasks"])(),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listUsers"])()
    ]);
    const withDetails = assignments.map((a)=>{
        ...
        return {
            ...a,
            taskTitle: t?.title || `Task #${a.taskId}`,
            taskPoints: t?.points ?? 0,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5dd6a15d._.js.map