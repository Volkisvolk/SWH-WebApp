...
"[project]/node_modules/steno/lib/index.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/lowdb/lib/adapters/node/TextFile.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs$2f$promises__$5b$external$5d$__$28$node$3a$fs$2f$promises$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/node:fs/promises [external] (node:fs/promises, cjs)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/node:path [external] (node:path, cjs)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$steno$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/steno/lib/index.js [app-route] (ecmascript)");
;
;
;
;
class TextFile {
    ...
    constructor(filename){
        this.#filename = filename;
        this.#writer = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$steno$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Writer"](filename);
    }
    async read() {
        let data;
        try {
...
"[project]/node_modules/lowdb/lib/adapters/node/DataFile.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lowdb$2f$lib$2f$adapters$2f$node$2f$TextFile$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/lowdb/lib/adapters/node/TextFile.js [app-route] (ecmascript)");
;
class DataFile {
    #adapter;
    #parse;
    ...
    constructor(filename, { parse, stringify }){
        this.#adapter = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lowdb$2f$lib$2f$adapters$2f$node$2f$TextFile$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TextFile"](filename);
        this.#parse = parse;
...
class DataFileSync {
    ...
    #stringify;
    constructor(filename, { parse, stringify }){
        this.#adapter = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lowdb$2f$lib$2f$adapters$2f$node$2f$TextFile$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TextFileSync"](filename);
        this.#parse = parse;
        this.#stringify = stringify;
    }
    read() {
...
"[project]/node_modules/lowdb/lib/adapters/node/JSONFile.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lowdb$2f$lib$2f$adapters$2f$node$2f$DataFile$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/lowdb/lib/adapters/node/DataFile.js [app-route] (ecmascript)");
;
class JSONFile extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lowdb$2f$lib$2f$adapters$2f$node$2f$DataFile$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DataFile"] {
    constructor(filename){
        super(filename, {
            parse: JSON.parse,
...
class JSONFileSync extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lowdb$2f$lib$2f$adapters$2f$node$2f$DataFile$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DataFileSync"] {
    constructor(filename){
        super(filename, {
            parse: JSON.parse,
            stringify: (data)=>JSON.stringify(data, null, 2)
...
"[project]/node_modules/lowdb/lib/adapters/Memory.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/lowdb/lib/core/Low.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/lowdb/lib/presets/node.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lowdb$2f$lib$2f$adapters$2f$Memory$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/lowdb/lib/adapters/Memory.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lowdb$2f$lib$2f$adapters$2f$node$2f$JSONFile$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/lowdb/lib/adapters/node/JSONFile.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lowdb$2f$lib$2f$core$2f$Low$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/lowdb/lib/core/Low.js [app-route] (ecmascript)");
;
;
;
async function JSONFilePreset(filename, defaultData) {
    const adapter = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lowdb$2f$lib$2f$adapters$2f$node$2f$JSONFile$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["JSONFile"](filename);
    const db = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lowdb$2f$lib$2f$core$2f$Low$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Low"](adapter, defaultData);
    await db.read();
    return db;
}
function JSONFileSyncPreset(filename, defaultData) {
    const adapter = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lowdb$2f$lib$2f$adapters$2f$node$2f$JSONFile$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["JSONFileSync"](filename);
    const db = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lowdb$2f$lib$2f$core$2f$Low$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["LowSync"](adapter, defaultData);
    db.read();
    return db;
}
}),
"[project]/node_modules/lowdb/lib/node.js [app-route] (ecmascript) <locals>": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/lowdb/lib/node.js [app-route] (ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lowdb$2f$lib$2f$adapters$2f$node$2f$TextFile$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/lowdb/lib/adapters/node/TextFile.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lowdb$2f$lib$2f$presets$2f$node$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/lowdb/lib/presets/node.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lowdb$2f$lib$2f$node$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/lowdb/lib/node.js [app-route] (ecmascript) <locals>");
}),
"[project]/node_modules/next/dist/esm/build/templates/app-route.js { INNER_APP_ROUTE => \"[project]/src/app/api/admin/tasks/set-tag/route.ts [app-route] (ecmascript)\" } [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$response$2d$cache$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/node_modules/next/dist/esm/server/response-cache/index.js [app-route] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$response$2d$cache$2f$types$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/esm/server/response-cache/types.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$admin$2f$tasks$2f$set$2d$tag$2f$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/api/admin/tasks/set-tag/route.ts [app-route] (ecmascript)");
;
;
;
;
...
const routeModule = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$route$2d$modules$2f$app$2d$route$2f$module$2e$compiled$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppRouteRouteModule"]({
    definition: {
        ...
        page: "/api/admin/tasks/set-tag/route",
        pathname: "/api/admin/tasks/set-tag",
        filename: "route",
        bundlePath: ""
    },
    distDir: ("TURBOPACK compile-time value", ".next") || '',
    projectDir: ("TURBOPACK compile-time value", "") || '',
    resolvedPagePath: "[project]/src/app/api/admin/tasks/set-tag/route.ts",
    nextConfigOutput,
    userland: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$admin$2f$tasks$2f$set$2d$tag$2f$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
});
...
async function handler(req, res, ctx) {
    ...
    let srcPage = "/api/admin/tasks/set-tag/route";
...
//# sourceMappingURL=node_modules_8660c65d._.js.map