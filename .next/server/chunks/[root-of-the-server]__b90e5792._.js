...
async function GET(req) {
    ...
    const users = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listUsers"])();
...
async function PATCH(req) {
    ...
    if (!body?.userId || !body.role) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'userId and role required'
    }, {
        status: 400
    });
    const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateUserRole"])(body.userId, body.role);
...
async function DELETE(req) {
    ...
    const ok = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteUser"])(userId);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b90e5792._.js.map