...
function RegisterPage() {
    ...
    const register = async (e)=>{
        ...
        setMsg('');
        if (!tagId || !name) {
            setMsg('Bitte Tag-ID und Namen angeben.');
            return;
        }
        ...
        if (!r.ok) {
            setMsg(d.error || 'Registrierung fehlgeschlagen');
            return;
        }
    ...
    const quickLogin = async ()=>{
        ...
        const d = await r.json();
        if (d === null || d === void 0 ? void 0 : d.needsRegistration) {
            setMsg('Bitte zuerst registrieren.');
            return;
        }
...
_s(RegisterPage, "8vPbNpqTN60zUnl2+1wtmA2fEF0=");
_c = RegisterPage;
var _c;
