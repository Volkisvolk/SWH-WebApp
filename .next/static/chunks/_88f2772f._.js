...
function AdminAssignPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminAssignPage.useEffect": ()=>{
            ({
                "AdminAssignPage.useEffect": async ()=>{
                    const u = await fetch('/api/admin/users').then({
                        "AdminAssignPage.useEffect": (r)=>r.json()
                    }["AdminAssignPage.useEffect"]);
                    const t = await fetch('/api/tasks').then({
                        "AdminAssignPage.useEffect": (r)=>r.json()
                    }["AdminAssignPage.useEffect"]);
                    setUsers(u.users || []);
                    setTasks(t.tasks || []);
...
_s(AdminAssignPage, "ySwLcCFCVwbJLBQbOWqYglfLeHw=");
_c = AdminAssignPage;
var _c;
...
//# sourceMappingURL=_88f2772f._.js.map